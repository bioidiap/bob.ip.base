...
project = u'xbob.ip.base'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.ip.base')[0]
...
htmlhelp_basename = 'xbob_ip_base_doc'
...
latex_documents = [
  ('index', 'xbob_ip_base.tex', u'Bob Image Processing Utilities',
...
man_pages = [
    ('index', 'xbob_ip_base', u'Bob Image Processing Utilities', [u'Idiap Research Institute'], 1)
]
